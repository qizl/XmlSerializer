...
using System.IO;
using System.Xml;
using Com.EnjoyCodes.SharpSerializer.Advanced;
using Com.EnjoyCodes.SharpSerializer.Advanced.Binary;
using Com.EnjoyCodes.SharpSerializer.Advanced.Deserializing;
using Com.EnjoyCodes.SharpSerializer.Advanced.Serializing;
using Com.EnjoyCodes.SharpSerializer.Advanced.Xml;
using Com.EnjoyCodes.SharpSerializer.Core;
...
namespace Com.EnjoyCodes.SharpSerializer
{
    ...
    public sealed class SharpSerializer
    {
        ...
        private void initialize(SharpSerializerBinarySettings settings)
        {
            ...
            // Create Serializer and Deserializer
            Com.EnjoyCodes.SharpSerializer.Advanced.Binary.IBinaryReader reader = null;
            Com.EnjoyCodes.SharpSerializer.Advanced.Binary.IBinaryWriter writer = null;
